...
export function UsuariosList() {
  ...
  <div className="flex flex-wrap w-full mb-6">
    <div className="bg-[#1572E8] text-white py-4 px-4 text-xl font-bold w-full sm:w-1/5 flex flex-col justify-center">
  ...
  {/* Footer */}
  <footer className="bg-gradient-to-r from-[#00498B] to-[#001325] text-white py-4 px-8 text-xl font-bold flex justify-center mt-6"> {/* Agregado margen superior mt-6 */}
